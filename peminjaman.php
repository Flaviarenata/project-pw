...
<script>
  ...
  if (alertTrigger) {
    alertTrigger.addEventListener('click', () => {
      ...
      const borrowerName = document.getElementById('exampleInputName').value;
      ...
      if (borrowedBooks.includes(selectedBook)) {
        appendAlert('Buku ini sudah dipinjam!', 'danger');
        return;
      }
      ...
      const data = { book: selectedBook, borrower: borrowerName, date: selectedDate };
      ...
      document.querySelector(`#bookSelect option[value="${selectedBook}"]`).disabled = true;
    });
  }
</script>